    ...
    public class StatCalculation
    {
        ...
        public void computeScore(Coup c)
        {
            ...
            if (set.getpoint(c.joueur) >= 6)
            {
                ...
                {
                    joueurMatch[c.joueur].addSet(new Set());
                }
            }
        ...
        public void computeStat(Coup c)
        {
            ...
            if (c.typeCoup == "Service")
            {
                ...
                if (c.gagnant)
                {
                    ...
                    stat.TauxServiceGagnant = stat.NbServiceGagnant / stat.NbService;
                }
            }
            ...
            else if (c.typeCoup == "revers")
            {
                ...
                if (c.gagnant)
                {
                    ...
                    stat.TauxReversGagnant = stat.NbReversGagnant / stat.NbRevers;
                }
            }
            ...
            else if (c.typeCoup == "coup droit")
            {
                ...
                {
                    stat.NbDroitGagnant++;
                    stat.TauxCoupDroitGagnant = stat.NbDroitGagnant / stat.NbDroit;
                }
            }
            ...
            {
                stat.NbCentre++;
                stat.TauxCentre = stat.NbCentre / stat.NbCoupTotal;
            }
            else if(c.position == "gauche")
            {
                stat.NbGauche++;
                stat.TauxGauche = stat.NbGauche / stat.NbCoupTotal;
            }
            else if (c.position == "droite")
            {
                stat.NbDroite++;
                stat.TauxDroite = stat.NbDroite / stat.NbCoupTotal;
            }
